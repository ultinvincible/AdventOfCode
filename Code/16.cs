...
{
    class Packets : AoCDay
    {
        public Packets() : base(16, false) { }
        class Packet
        {
        ...
        {
            Packet.Transmission = "";
            foreach (char hex in inputString[..^1])
            ...
            outermost = Decode(0);
            Console.WriteLine(VersionSum(outermost));
            Console.WriteLine(outermost.value);
        }
